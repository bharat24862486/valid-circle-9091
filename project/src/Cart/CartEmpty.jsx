...
const CartEmpty = () => {
  ...
  return (
    ...
    <Stack display={'flex'} justifyContent={'center'} alignItems={'center'} p={'5rem'}>
     <Image style={{objectFit:'contain'}} w={'250px'} h={'300px'} src='https://constant.myntassets.com/checkout/assets/img/empty-bag.png' />

    <Text m={0} p={0} fontSize={'25px'} color={'black'}  > Hey, it feels so light!</Text>
    <Text m={0} p={0} fontSize={'18px'} color={'black'}  > There is nothing in your bag. Let's add some items.</Text>
    <br />
